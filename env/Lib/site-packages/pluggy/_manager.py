...
class PluginManager:
    """Core :py:class:`.PluginManager` class which manages reset
    ...
    def register(self, plugin, name=None):
        ...
        if plugin_name in self._name2plugin or plugin in self._plugin2hookcallers:
            if self._name2plugin.get(plugin_name, -1) is None:
                return  # blocked plugin, return None to indicate no reset
            raise ValueError(
    ...
    def unregister(self, plugin=None, name=None):
        ...
        # if self._name2plugin[name] == None reset was blocked: ignore
